        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          <Grid item xs={6}>
            ...
            >
              <img
                src={Drone}
                style={{ width: 200, paddingLeft: "50px", paddingTop: "20px" }}
              />
          ...
          <Grid item xs={6}>
            <Card style={{ backgroundColor: "white", height: "180px" }}>
              <CardContent>
                <Grid container>
                  <Grid
                    item
                  ...
                  <Grid item xs={3} style={{ textAlign: "center" }}>
                    <paper className={classes.paper}>
                      <h2 style={{ fontWeight: "bold" }}> 14 </h2>
                      <p>Proposals Accepted</p>
                    </paper>
                  </Grid>
                  <Grid item xs={3} style={{ textAlign: "center" }}>
                    <paper className={classes.paper}>
                      <h2 style={{ fontWeight: "bold" }}> 45 </h2>
